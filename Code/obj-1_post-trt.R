...
# Fit models
csg.trt.cgr.fit <- lm.rrpp(CSG ~ Herbicide.Treatment, data = cgr, iter = 9999)
csg.trt.ugr.fit <- lm.rrpp(CSG ~ Herbicide.Treatment, data = ugr, iter = 9999)

# Get pairwise comps
csg.trt.cgr.pairs <- simp.rrpp(pairwise(csg.trt.cgr.fit, fit.null = NULL, groups = cgr$Herbicide.Treatment))
...
fsc.trt.cgr.fit <- lm.rrpp(Fescue ~ Herbicide.Treatment, data = cgr, iter = 9999)
fsc.trt.cgr.pairs <- simp.rrpp(pairwise(fsc.trt.cgr.fit, fit.null = NULL, groups = cgr$Herbicide.Treatment))
fsc.trt.cgr.pairs
  ## Con = A | Spr = B | SnS = B

fsc.trt.ugr.fit <- lm.rrpp(Fescue ~ Herbicide.Treatment, data = ugr, iter = 9999)
...
anova(lm.rrpp(Forbs ~ Herbicide.Treatment + Year, data = cgr, iter = 9999), effect.type = "F") # trt = sig

anova(lm.rrpp(Forbs ~ Herbicide.Treatment * Year, data = ugr, iter = 9999), effect.type = "F") # interxn = NS
anova(lm.rrpp(Forbs ~ Herbicide.Treatment + Year, data = ugr, iter = 9999), effect.type = "F") # trt = sig

frb.trt.cgr.fit <- lm.rrpp(Forbs ~ Herbicide.Treatment, data = cgr, iter = 9999)
frb.trt.cgr.pairs <- simp.rrpp(pairwise(frb.trt.cgr.fit, fit.null = NULL, groups = cgr$Herbicide.Treatment))
frb.trt.cgr.pairs
  ## Con = A | Spr = B | SnS = B

frb.trt.ugr.fit <- lm.rrpp(Forbs ~ Herbicide.Treatment, data = ugr, iter = 9999)
frb.trt.ugr.pairs <- simp.rrpp(pairwise(frb.trt.ugr.fit, fit.null = NULL, groups = ugr$Herbicide.Treatment))
frb.trt.ugr.pairs
  ## Con = A | Spr = B | SnS = B
